...
faceDet2 = cv2.CascadeClassifier("HAAR/haarcascade_frontalface_alt2.xml")
faceDet3 = cv2.CascadeClassifier("HAAR/haarcascade_frontalface_alt.xml")
faceDet4 = cv2.CascadeClassifier("HAAR/haarcascade_frontalface_alt_tree.xml")
